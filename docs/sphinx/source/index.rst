.. solarspatialtools documentation master file, created by
...
Installation
------------
The package can be most easily installed via `PyPi <https://pypi.org/project/solarspatialtools/>`_ with the following command::
...
Getting Started
---------------
The functions in this package likely to be of general interest to the research community are those in the modules :mod:`solarspatialtools.cmv` and :mod:`solarspatialtools.field`.

The :mod:`solarspatialtools.cmv` module contains functions for calculating the cloud motion vector from a distributed network of irradiance measurements.
